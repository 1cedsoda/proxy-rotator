...
func (s *GeonodeSource) Resolve(ctx context.Context, _ *proxykit.Request) (*proxykit.Result, error) {
...
func gnBuildUsername(cfg *GeonodeConfig, seed *proxykit.SessionSeed) string {
