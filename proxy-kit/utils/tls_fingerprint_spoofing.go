...
//
// It builds on proxykit.MITM: the TLS termination, cert forging, and pipeline
...
//	    proxykit.Auth(auth,
//	        proxykit.Session(source),
//	    ),
//	)
//	proxykit.ListenHTTP(":8100", pipeline)
//
...
func TLSFingerprintSpoofing(ca tls.Certificate, preset string, inner proxykit.Handler) proxykit.Handler {
	...
	return proxykit.MITM(certs, &tlsFingerprintInterceptor{preset: preset}, inner)
}
